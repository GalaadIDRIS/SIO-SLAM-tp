...
<html lang="<?php echo $lang; ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/jquery/datatables.bootstrap.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/jquery/datatables.min.css'); ?>">

        <script src="<?php echo base_url($frameworks_dir . '/jquery/jquery.min.js'); ?>"></script>
        <script src="<?php echo base_url($frameworks_dir . '/jquery/datatable.js'); ?>"></script>
        <script src="<?php echo base_url($frameworks_dir . '/jquery/datatables.min.js'); ?>"></script>
        <script src="<?php echo base_url($frameworks_dir . '/jquery/datatables.bootstrap.js'); ?>"></script>
