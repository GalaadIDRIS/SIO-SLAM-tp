...
<?php foreach ($groups as $values):?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo anchor("admin/groups/edit/".$values->id, '<button type="button" title="Modifier" class="btn btn-labeled btn-xs btn-warning"><span class="btn-label"><i class="fa fa-edit"></i></span></button>') ?> &nbsp;
                                                </td>
                                            </tr>
<?php endforeach;?>
                                        </tbody>
